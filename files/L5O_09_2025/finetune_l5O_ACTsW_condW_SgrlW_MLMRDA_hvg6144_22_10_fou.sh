...
export MY_DATA_FILE=/sci/backup/dandanbz/haya.benhayon/IBM/Seurat/all_celltypes/run6_from_start_with_metadata_allcelltypes_minimal_codinggenes_condition_alpha_sub700_L5Osplit_hvg6144.h5ad

work_dir=/sci/backup/dandanbz/haya.benhayon/IBM/finetune_bimed/ACT_l50

run_file_name=ACTsW2_condW2_S2grlW1_MLMRDA_hvg6144_22_10

#for sample in H087 H084 H055 ; do

for sample in H084 ; do
    bmfm-targets-run -cn finetune_l5O_ACTsW_condW_SgrlW_MLMRDA_hvg6144_22_10 \
        L5O_sample=$sample \
