...
export MY_DATA_FILE=/sci/backup/dandanbz/haya.benhayon/IBM/Seurat/all_celltypes/run6_from_start_with_metadata_allcelltypes_minimal_codinggenes_condition_alpha_sub700_L5Osplit_recent.h5ad

work_dir=/sci/backup/dandanbz/haya.benhayon/IBM/finetune_bimed/ACT_l50

run_file_name=ACTs_recent_MLMRDA_28_9

for sample in H087 H084 H055 ; do
    bmfm-targets-run -cn finetune_l5O_ACTs_recent_MLMRDA_28_9 \
        L5O_sample=$sample \
