...
export MY_DATA_FILE=/sci/backup/dandanbz/haya.benhayon/IBM/Seurat/all_celltypes/run6_allcellstype_rawRP_minimal_codinggenes_condition_alpha_satu_L5Osplit_split_HC2_hvg6144_alpha.h5ad
...
all_cells=Interpret_13_01

all_cells=Interpret_18_01_2048

all_cells=Interpret_20_01_4096_lb

for sample in H123 H113 H087 H020 H021 H028 H064 H084 H023 H055; do # H032 H071
...
EOF
    ...
    # Run bmfm on subset
    bmfm-targets-run -cn Inter_L5O_ACTsW_condW_SgrlW_MLMRDA_10_9 \
