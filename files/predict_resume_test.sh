...
export MY_DATA_FILE=/sci/backup/dandanbz/haya.benhayon/IBM/Seurat/all_celltypes/a.h5ad
...
bmfm-targets-run -cn predict_test \
     input_file=$MY_DATA_FILE \
     file_name=${run_file_name}_resume_${pooling}_test \
