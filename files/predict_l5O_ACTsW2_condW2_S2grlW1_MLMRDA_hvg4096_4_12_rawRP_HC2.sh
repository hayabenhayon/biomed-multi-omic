...
export MY_DATA_FILE=/sci/backup/dandanbz/haya.benhayon/IBM/Seurat/all_celltypes/run6_allcellstype_rawRP_minimal_codinggenes_condition_alpha_satu_L5Osplit_split_HC2_hvg6144.h5ad
