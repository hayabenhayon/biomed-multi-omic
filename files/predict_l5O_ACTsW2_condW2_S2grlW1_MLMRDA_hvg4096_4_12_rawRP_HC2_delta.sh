...
export MY_DATA_FILE=/sci/backup/dandanbz/haya.benhayon/IBM/Seurat/all_celltypes/run6_allcellstype_rawRP_minimal_codinggenes_condition_alphadelta_satu_L5Osplit_split_HC2_hvg6144.h5ad
...
EOF
    ...
    # Run bmfm on subset
    bmfm-targets-run -cn predict_L5O_ACTsW_condW_SgrlW_MLMRDA_10_9_delta \
