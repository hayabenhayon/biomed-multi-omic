...
export MY_DATA_FILE=/sci/backup/dandanbz/haya.benhayon/IBM/Seurat/all_celltypes/run6_allcellstype_rawRP_minimal_codinggenes_condition_alphadelta_satu_L5Osplit_split_HC2_sub700_hvg6144.h5ad
...
for sample in H087 H084 H055 ; do
    bmfm-targets-run -cn finetune_l5O_ACTsW2_condW2_S2grlW1_MLMRDA_hvg4096_19_11_raw_delta \
        L5O_sample=$sample \
