...
#MLM+RDA
work_dir=/sci/backup/dandanbz/haya.benhayon/IBM/predict_biomed/alpha/alpha_MLM_RDA_20_7/
...
#WCED+Multitask
work_dir=/sci/backup/dandanbz/haya.benhayon/IBM/predict_biomed/alpha/alpha_WCED_Multitask_20_7/
#bmfm-targets-run -cn predict input_file=$MY_DATA_FILE working_dir=$work_dir checkpoint=ibm-research/biomed.rna.bert.110m.wced.multitask.v1
echo done

#WCED
work_dir=/sci/backup/dandanbz/haya.benhayon/IBM/predict_biomed/alpha/alpha_WCED_20_7/
