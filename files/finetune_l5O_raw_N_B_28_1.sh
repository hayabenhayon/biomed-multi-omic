...
TMP_DIR="/sci/backup/dandanbz/haya.benhayon/IBM/Seurat/all_celltypes/temp1.h5ad"
...
for N in Ns:
    for B in range(1, N_BOOTSTRAP + 1):
        ...
        adata_sub.write("/sci/backup/dandanbz/haya.benhayon/IBM/Seurat/all_celltypes/tmp1.h5ad")

        cmd = f"""
bmfm-targets-run -cn finetune_l5o_N_B_28_1 \
  L5O_sample={col} \
  file_name={run_file_name} \
  input_file=/sci/backup/dandanbz/haya.benhayon/IBM/Seurat/all_celltypes/tmp1.h5ad \
